...
# ubuntu-iso-builder-respin-xfce
...
> [ubuntu-iso-builder-respin-xfce](https://samwhelp.github.io/ubuntu-iso-builder-respin-xfce/)
...
| Config |
| ------ |
| [~/.config](https://github.com/samwhelp/ubuntu-iso-builder-respin-xfce/tree/main/template/asset/overlay/etc/skel/.config) |
| [/usr/share/glib-2.0/schemas](https://github.com/samwhelp/ubuntu-iso-builder-respin-xfce/tree/main/template/asset/overlay/usr/share/glib-2.0/schemas) |
| [/etc/dconf/db/distro.d](https://github.com/samwhelp/ubuntu-iso-builder-respin-xfce/tree/main/template/asset/overlay/etc/dconf/db/distro.d) |
...
> clone [ubuntu-iso-builder-respin-xfce](https://github.com/samwhelp/ubuntu-iso-builder-respin-xfce)

``` sh
git clone https://github.com/samwhelp/ubuntu-iso-builder-respin-xfce.git
```


> change dir to `ubuntu-iso-builder-respin-xfce`

``` sh
cd ubuntu-iso-builder-respin-xfce
```
